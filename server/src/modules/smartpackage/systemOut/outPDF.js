...
<div class="title-text">
                ข้อมูลเบิกใช้งาน ต้นทาง: <span style="color: blue; text-decoration: underline; font-weight: bold;">${origin || '-'}</span> ถึง ปลายทาง: <span style="color: blue; text-decoration: underline; font-weight: bold;">${destination || '-'}</span> (จำนวน <span class="totalPages"></span> หน้า)
            </div>
            <div class="subtitle-text">
                วันที่เบิกใช้งาน: ${createDate} เวลา: ${createTime} น.
            </div>
        </div>
    `;
