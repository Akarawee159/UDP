// src/modules/Smartpackage/systemRepair/systemRepairRoutes.js
'use strict';

const express = require('express');
const router = express.Router();
const auth = require('../../../auth/middleware/authMiddleware');
const controller = require('./systemRepairController');
...
//  Routes สำหรับหน้า RepairRequestLog (รายการแจ้งซ่อม/รอรับเข้า)
router.get('/repair-list', auth, controller.getRepairList); // ดึงรายการ asset_status = 104
router.post('/receive-repair', auth, controller.receiveRepairAssets); // รับเข้าคลัง (104 -> 100)
