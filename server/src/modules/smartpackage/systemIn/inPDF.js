...
<div class="title-text">
                ข้อมูลรับเข้า รับเข้าจาก: <span style="color: blue; text-decoration: underline; font-weight: bold;">${origin || '-'}</span> ถึง ต้นทางที่รับ: <span style="color: blue; text-decoration: underline; font-weight: bold;">${destination || '-'}</span> (จำนวน <span class="totalPages"></span> หน้า)
            </div>
