// src/modules/settings/countingunit/countingunitController.js
'use strict';

const model = require('./countingunitModel');
...
/** POST /api/settings/countingunit */
async function create(req, res, next) {
  try {
    ...
    if (io) io.emit('countingunit:upsert', row); // ✅ Event: countingunit
...
async function remove(req, res, next) {
  try {
    ...
    const io = req.app.get('io');
    if (io) io.emit('countingunit:delete', { G_ID }); // ✅ Event: countingunit
