// src/modules/settings/area/areaController.js
'use strict';

const model = require('./areaModel');
...
async function create(req, res, next) {
  try {
    ...
    if (io) io.emit('area:upsert', row); // ✅ Event: area
...
async function remove(req, res, next) {
  try {
    ...
    const io = req.app.get('io');
    if (io) io.emit('area:delete', { G_ID }); // ✅ Event: area
