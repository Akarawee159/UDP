...
async function getAll(startDate, endDate) {
  let sql = `
    SELECT 
        ...
        a.asset_width, a.asset_width_unit, a.asset_length, a.asset_length_unit, a.asset_height, a.asset_height_unit,
        ...
        CONCAT(COALESCE(e2.titlename_th, ''), COALESCE(e2.firstname_th, ''), ' ', COALESCE(e2.lastname_th, '')) AS scan_by_name,
    ...
    LEFT JOIN employees e2 ON a.scan_by = e2.employee_id
