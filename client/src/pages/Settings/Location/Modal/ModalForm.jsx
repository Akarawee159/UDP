                    ...
                    <div className="p-8">
                        <Form form={form} layout="vertical" autoComplete="off" className="space-y-2">
                            <Form.Item label={<span className="font-semibold text-gray-700">รหัสโลเคชั่น</span>} name="G_CODE" rules={[{ required: true, message: 'กรุณาระบุรหัสโลเคชั่น' }, { validator: validateCode }]} hasFeedback validateStatus={checkingCode ? 'validating' : undefined}>
                                {/* ✅ ปรับเป็น h-9 */}
                                <Input prefix={<IdcardOutlined className="text-gray-400" />} placeholder="เช่น LCT01" className="h-9 rounded-lg border-gray-200 focus:border-blue-500 hover:border-blue-400  focus:bg-white transition-all" allowClear />
                            </Form.Item>
                            <Form.Item label={<span className="font-semibold text-gray-700">ชื่อโลเคชั่น</span>} name="G_NAME" rules={[{ required: true, message: 'กรุณาระบุชื่อโลเคชั่น' }]}>
                                {/* ✅ ปรับเป็น h-9 */}
                                <Input prefix={<TagOutlined className="text-gray-400" />} placeholder="ระบุชื่อโลเคชั่น" className="h-9 rounded-lg border-gray-200 focus:border-blue-500 hover:border-blue-400  focus:bg-white transition-all" allowClear />
                            </Form.Item>
                        </Form>
                    </div>
                </Spin>
